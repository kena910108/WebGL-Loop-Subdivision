...
export class GUI implements IGUI {
  ...
  public onKeydown(key: KeyboardEvent): void {
    switch (key.code) {
      case "Digit1": {
        this.animation.iscat = 0;
        this.animation.setScene("/static/assets/skinning/rockLP.dae");
        break;
      }
      case "Digit2": {
        this.animation.iscat = 1;
        this.animation.setScene("/static/assets/skinning/cat.dae");
        break;
      }
      case "Digit3": {
        this.animation.setScene("/static/assets/skinning/cat.dae");
      ...
      case "Digit7": {
        this.animation.Nooutlines = 1 - this.animation.Nooutlines;
        this.animation.initScene();
        break;
      }
      case "Digit8": {
        this.animation.getScene().meshes[0].loop_subdivision();
        this.animation.initScene();
        break;
      }
      case "KeyW": {
